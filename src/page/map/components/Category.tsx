    ...
    >
      ...
      {listView ? (
        ...
        <li
          ...
          } z-10 mr-[8px] flex shrink-0 items-center rounded-[25px] bg-white pb-[3px] pl-[3px] pr-[9px] pt-[3px] text-center text-[12px] text-[#3d3d3d] shadow-[0_1px_2px_0_rgba(0,0,0,0.2)]`}
          key="BOOKMARK"
          onClick={clickEventHandler}
          role="none"
          value="BOOKMARK"
